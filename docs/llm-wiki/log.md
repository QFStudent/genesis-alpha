...
## [2026-08-03] update | Created syntheses/SchlichtVC-ProdSimReplication.md — filed the VC comparison analysis: Schlicht VC.m vs ga/vc/schlicht.py (same algorithm, optimizer/sparse/panel gaps); prod TOD-MISO "VC" vs ga/sim replication (structure match, calc_tv_coefficients stub uncertainty); online/fracdiff confidence; codebase map and open questions. index.md: Syntheses section + Pages 23→24
